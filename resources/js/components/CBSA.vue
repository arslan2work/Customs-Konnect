  ...
  <div>
    <div class="card" >
      <div class="card-header">
        <h3 class="card-title">Canadian Border Service Agency</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              >
                ...
                <tbody>
                  <tr class="odd" v-for="user in acis.data" :key="user.id" v-if="users.id  == user.company_id">
                    <td>{{ user.id }}</td>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th rowspan="1" colspan="1">Quantity (Boxes)</th>
                    <th rowspan="1" colspan="1">Weight (Pounds)</th>
